		...
		<div class='footer_txt'>
			<div class='container'>
				...
				<?php /* 
					...
					You can buy this theme without footer links online at http://smthemes.com/buy/originative/
				*/ ?>
				<div class='smthemes'>Designed by <a href='http://smthemes.com/' target='_blank'>WordPress template</a>, thanks to: <a href='http://www.boxintense.com/managed-vps/' target='_blank'>Best Managed VPS</a>, <a href='http://www.linkslive.info/' target='_blank'>Web Directory</a> and <a href='http://fthe.me' target='_blank'>FThe.me</a></div>
			</div>
			</div>
		<?php wp_footer(); ?>
